$(document).ready(function(){
    ...
    $("#fecha_turno_espermograma").on('change', function(){
      var fecha = $("#fecha_turno_espermograma").val();
      location.href="/espermograma?f="+fecha; 
    });
    ...
    for (let index = 26; index < 30; index++) {
      ...
      $("#obra_social"+index).on('change', function(){
        ...
        $.ajax({
          ...
          success:function(datos){
            $("#nomenclador_espermograma").val(datos);
          }
        });
      });
      ...
      $("#practicas"+index).on('click', function(){
        ...
        var nomenclador = $("#nomenclador_espermograma").val();
      ...
      $("#guardar"+index).on('click', function(){
        var fecha_turno = $("#fecha_turno_espermograma").val();
        ...
        $.ajax({
          ...
          success:function(datos){
            if (datos == "Correcto") {
              location.href = "/espermograma?f="+fecha_turno;
