...
<title>Gestión de turnos | Espermograma</title>
...
<div class = "col-sm-2" style = "margin-top:10px;">
    <input type = "date" class = "form-control" id = "fecha_turno_espermograma" min = "<?php echo $fecha=date('Y-m-d'); ?>" value = "<?php echo $fecha=$_GET['f']; ?>">
</div>
...
<div class = "col-sm-4" style = "margin-top:10px;">
    <div class="card card-navy collapsed-card">
        <div class="card-header">
            <?php
                $cantidad = App\Models\pacientes_turno::where([['fecha', $fecha],['id_horario', $horario->id_horario], ['para', 'espermograma']])->get()->count();
            ?>
        ...
        <div class = "row" style = "margin-top:5px;">
            <input type = "number" id = "nomenclador_espermograma" hidden>
            <div class = "col-sm-12">
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Turnero\resources\views/turnos/espermograma.blade.php ENDPATH**/ ?>