...
<table class="table" style = "margin-top:10px;">
    ...
    <tr>
        ...
        <td><button wire:click='editar_turno("<?php echo e($turno_espermograma->id_turno); ?>", "<?php echo e($fecha); ?>", "<?php echo e($turno_espermograma->horario); ?>", "<?php echo e($turno_espermograma->id_horario); ?>", "espermograma")' style = "border:none;background-color:transparent;"><i class="far fa-calendar-alt"></i></button></td>
        <?php if((Auth::user()->rol == 'desarrollador')||(Auth::user()->rol == 'administrador')): ?>
...
</div><?php /**PATH C:\laragon\www\Turnero\resources\views/ver-turnos/tablas/tabla_espermograma.blade.php ENDPATH**/ ?>