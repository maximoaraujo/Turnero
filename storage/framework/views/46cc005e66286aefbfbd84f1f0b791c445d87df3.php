<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/rechazo" style = "font-weight: bold;font-size:18px;"><?php echo e(__('Rechazo turno')); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/consultas" style = "font-weight: bold;font-size:18px;"><?php echo e(__('Consultas')); ?></a>
        </li>
        </ul> 
