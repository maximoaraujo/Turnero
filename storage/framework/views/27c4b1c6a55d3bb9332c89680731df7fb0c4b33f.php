    ...
    <div class="card-body px-0 pb-0">
        ...
        <div class="row mt-3 pt-3">
            ...
            <div class="list-group">
                ...
                <span class="text-success"><?php echo e($total); ?></span>
                </a>
                ...
                <span class="text-danger"><?php echo e($asistidos); ?></span>
                </a>
                ...
                <span style = "color:#46BFBD;font-wight:bold;"><?php echo e($no_asistidos); ?></span>
                </a>
            </div>
        </div>
        </div>
...
$(document).ready(function(){
    ...
    data: {
        ...
        datasets: [{
        data: [<?php echo e($asistidos); ?>, <?php echo e($no_asistidos); ?>],
...
</script><?php /**PATH C:\laragon\www\Turnero\resources\views/estadisticas/grafico_asistencia.blade.php ENDPATH**/ ?>