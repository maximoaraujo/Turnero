...
<table class="table" style = "margin-top:10px;">
    ...
    <tr>
        ...
        <?php endif; ?>    
        <td><a href = "/comprobante_turno/<?php echo e($fecha); ?>/<?php echo e($turno_citogenetica->id_horario); ?>/<?php echo e($turno_citogenetica->documento); ?>/<?php echo e($turno_citogenetica->paciente); ?>/<?php echo e($turno_citogenetica->id_turno); ?>" target='_blank'><button style = "border:none;background-color:transparent;"><i class="fas fa-file-import"></i></button></a></td>
        <?php if((Auth::user()->rol == 'desarrollador')||(Auth::user()->rol == 'administrador')): ?>
        <td nowrap><?php echo e($turno_citogenetica->name); ?>-<?php echo e(date('d-m-Y H:m:s', strtotime($turno_citogenetica->fecha_hora))); ?></td>
        <?php endif; ?>
    </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
</table>
</div><?php /**PATH C:\laragon\www\Turnero\resources\views/ver-turnos/tablas/tabla_citogenetica.blade.php ENDPATH**/ ?>