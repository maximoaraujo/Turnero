...
<div class="info-box bg-gradient-info">
    ...
    <div class="info-box-content">
        ...
        <span class="progress-description">
            <button type="button" class="btn btn-block btn-default btn-sm" wire:click='nuevo_turno("<?php echo e($horario->id_horario); ?>", "<?php echo e(Auth::user()->id); ?>", "citogenetica")'>Asignar</button>
        </span>
        <?php endif; ?>
        </div>
    </div>
...
</div><?php /**PATH C:\laragon\www\Turnero\resources\views/pacientes/turnos_para/citogenetica.blade.php ENDPATH**/ ?>