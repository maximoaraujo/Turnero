...
?>
<p id = "fecha_turno">Fecha: {{date('d-m-Y', strtotime($fecha))}}</p><p id = "hora_turno">Hora: <?php echo $horario; ?></p>
<?php
...
$dompdf->stream('comprobante_'.$paciente.'.pdf', array("Attachment" => false));
?>