...
?>
<p id = "paciente_turno">Paciente: {{$paciente}}<br><br>
Turno: <?php echo $dia; ?> {{date('d', strtotime($fecha))}} de <?php echo $mes; ?> del {{date('Y', strtotime($fecha))}}- <?php echo $horario; ?>hs </p>
<hr>

<p id = "solicito">Solicitó un turno para realizarse los siguientes estudios:</p>
@foreach($practicas as $practica)
    <ul>
        <li id = "lista">{{$practica->codigo}} - {{$practica->practica}}</li>
    </ul>
@endforeach
